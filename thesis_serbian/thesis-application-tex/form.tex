...
Svakodnevno se generishe velika kolichina podataka. Podaci mogu nastati iz raznih izvora, poput drushtvenih mrezha i kupovine preko interneta, ali i mnogih drugih. Imaju veliki broj primena i mogu se koristiti za, na primer, razne vrste analitika ili za pravljenje modela mashinskog uchenja. Obrada podataka se најчешће izvrshava коришћењем distribuiranih sistema. Distribuirani sistemi su sachinjeni od umrezhenih mashina koje medjusobno saradjuju i paralelno izvrshavaju posao. Primer takvog sistema je fajl sistem HDFS, centralni deo Hadup ekosistema [1]. Obrada velikih kolichina podataka se mozhe ostvariti podelom podataka na delove koji se zatim paralelno obradjuju na odvojenim mashinama. U distribuiranoj obradi podataka je zastupljen programski jezik Skala [2] u kome su napisani alati poput Sparka [3], Kafke i Flinka.

Geoprostorni podaci su podaci koji predstavljaju lokacije na geografskoj mapi, kao i njihov opis. Pored toga shto se koriste u aplikacijama kojima je primarna svrha rad sa mapama, koriste se i za optimalan raspored raznih vrsta infrastrukura, zdravstvenih centara i slichno. Kombinovanjem sa drugim podacima se mogu koristiti za predvidjanje vremenskih prilika, kao i za razne geografske vizualizacije. Jedan primer javno dostupnih geoprostornih podataka je OSM [4].

\textbf{Specifichni cilj rada:}

U okviru rada bic1e prikazan nachin rada distribuiranih sistema i tehnologija koje se mogu koristiti za obradu velike kolichine podataka. Takodje, bic1e implementirana aplikacija za rad sa geoprostornim podacima koja se mozhe koristiti radi boljeg iskustva korisnika koji koriste geografske mape. Aplikacija c1e koristiti programski jezik Skala i Spark biblioteku. Za prikaz rezultata obrade podataka c1e se koristiti programski jezik Javaskript.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\makebox[5.5cm][c]{11.5.2022.}\makebox[5.5cm]{} Chlanovi komisije\\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
