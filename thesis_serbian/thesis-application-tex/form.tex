...
Danas se generishe velika kolichina podataka i njihova obrada je iz tog razloga shto podaci imaju razne primene, kao shto su razne vrste analitike, pravljenje modela mashinskog uchenja i druge.

Velike kolichine podataka se obradjuju tako shto se dele na delove i ti delovi se obradjuju paralelno na razlichitim mashinama. Sistemi koji obradjuju podatke na takav nachin se zovu distribuirani sistemi.

Geoprostorni podaci su bitni i imaju veliki broj primena. Pored toga shto doprinose radu aplikacijama koje koriste mape, mogu se koristiti za optimialan raspored raznih vrsta infrastrukura, zdravstvenih centara i slichno. Takodje, kombinovanjem sa drugim podacima se mogu koristiti za predvidjanje vremenske prognoze kao i za razne geografske vizualizacije. \\ \\ \\
...
Opis programskog jezika Skala i skupa podataka OSM. \\ \\ \\
