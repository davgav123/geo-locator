...
\kljucnereci{\textit{Scala}, Дистрибуирана обрада података, \textit{Hadoop}, \textit{Apache Spark}, Геопросторни подаци, \textit{OpenStreetMap}}
...
У овом раду је приказан опис дистрибуираних система, мотивација за њихово постојање и њихова организација. Такође је урађено и поређење између система који се састоје од једне машине и система који чини више машина. Детаљно су описани структура, начин рада и компоненте дистрибуираног система \textit{HDFS}. Приказан је и начин рада, али и недостаци \textit{MapReduce}-а, прве парадигме за дистрибуирану обраду података.
...
У раду су описане особине и основни принципи програмског језика Скала. Уз опис су приложени и конкретни примери. У овом програмском језику је написан \textit{Apache Spark}, који се користи за дистрибуирану обраду података.
...
Описани су основни концепти алата \textit{Apache Spark}, попут архитектуре, партиционисања података, кеширања, трансформација и акција. Поред концепата, детаљније су описане две компоненте \textit{Spark}-а за моделовање података \textit{RDD} и \textit{DataFrame}.

Приказана је имплементација апликације за дистрибуирану обраду скупа геопросторних података \textit{OpenStreetMap}. Обрада се извршава на \textit{HDFS}-у имплементираном од стране \textit{AWS}-а, сервису \textit{EMR}. За обраду података се користе \textit{Apache Spark} и програмски језик Скала. Намена апликације је да филтрира геопросторне податке тако што ће за сваку државу европе издвојити локације здравствених објеката, хотела, хостела, барова, ресторана и других битних туристичких локација које се унутар ње налазе, да би се те локације касније приказале на географској мапи. За приказ локација на географској мапи се користи јазик \textit{JavaScript} и биоблиотека \textit{Leaflet}.
